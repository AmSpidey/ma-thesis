...
It is one of the most widespread type of data, making its forecasting incredibly useful for vast industries and research areas. Among others it is being used for stock market analysis, weather prediction and resource allocation planning.
...
\begin{enumerate}
	...
	\item Time features as in the [ENHANCING LOCALITY] (on the data feeding side)
\end{enumerate}
